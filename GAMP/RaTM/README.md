...
Status: Implemented; SMT and SIT evidence current; historical authorized
`s-tau` HAT retained
...
| FS-020 | FS-020-HDS-010 | FS-010-HDS-010-SDS-010 | FS-120-HDS-010-SDS-010-SMS-010 | offline runtime and self-hosted bootstrap integration |
...
| FS-070 | FS-070-HDS-010 | FS-070-HDS-010-SDS-010 | FS-070-HDS-010-SDS-010-SMS-010 | policy evaluation, device ordering, carrier transitions, and jitter bounds |
| FS-075 | FS-075-HDS-010 | FS-075-HDS-010-SDS-010 | FS-075-HDS-010-SDS-010-SMS-010 | late-stop race, typed carrier stop, and explicit host-stop test |
...
| FS-140 | FS-140-HDS-010 | FS-140-HDS-010-SDS-010 | FS-140-HDS-010-SDS-010-SMS-010 | current SMT and SIT; HAT and SAT require separate authorization |

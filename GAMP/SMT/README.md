...
| FS-070-HDS-010-SDS-010-SMS-010 | OK | module and carrier-watcher tests; baseline promotion, explicit rollout, bad functional health, healthy recovery, foreground runner lifecycle, and observed carrier transition dispatch |
